<!-- Services--> <section class="page-section" id="services">
<div class="container">
 ...
 <span class="fa-stack fa-4x"> <i class="fas fa-circle fa-stack-2x text-primary"></i> <i class="fas fa-shopping-cart fa-stack-1x fa-inverse"></i> </span>
			...
			<p class="text-muted">
				 Lorem ipsum dolor sit amet, consectetur adipisicing elit. Minima maxime quam architecto quo invent ПОМЕНЕНО re harum ex magni, dicta impedit.
			</p>
		</div>
		<div class="col-md-4">
